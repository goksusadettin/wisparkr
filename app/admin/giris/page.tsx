    ...
    <div className="min-h-screen bg-[#0A0A0F] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="flex justify-center mb-8">
          <Image src="/logo.png" alt="Wisparkr" width={48} height={48} className="rounded-xl" />
        </div>

        <div className="glass border border-white/10 rounded-3xl p-8">
          <h1 className="text-2xl font-bold text-on-surface text-center mb-2">Admin Paneli</h1>
          <p className="text-on-surface-variant text-sm text-center mb-8">Giriş yaparak devam edin</p>

          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="block text-sm text-on-surface-variant mb-2">E-posta</label>
              <input
                type="email"
                value={email}
                ...
                placeholder="admin@wisparkr.com"
                required
              />
            </div>
            <div>
              <label className="block text-sm text-on-surface-variant mb-2">Şifre</label>
              <input
                type="password"
                value={password}
